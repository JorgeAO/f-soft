        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card-title">
                    <h6>Detalles del Tipo de Persona: <?= $this->title?></h6>
                    <p>
                        ...
                        <?= Html::a('<i class="fa fa-pencil-alt"></i> Editar', ['update', 'tipopers_codigo' => $model->tipopers_codigo], ['class' => 'btn btn-sm btn-personalizado']) ?>
                        <?= Html::a('<i class="fa fa-trash"></i> Eliminar', ['delete', 'tipopers_codigo' => $model->tipopers_codigo], [
