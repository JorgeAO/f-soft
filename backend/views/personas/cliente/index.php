                    ...
                    [
                        ...
                        'value'=> function($data) {
                            ...
                            $strOpciones = 
                                ...
                                Html::a('<i class="fa fa-eye"></i>', ['view', 'cliente_codigo' => $data->cliente_codigo], ['class' => 'btn btn-sm btn-personalizado', 'title'=>'Ver Detalles']).
                                Html::a('<i class="fa fa-pencil-alt"></i>', ['update', 'cliente_codigo' => $data->cliente_codigo], ['class' => 'btn btn-sm btn-personalizado', 'title'=>'Editar']).
                                Html::a('<i class="fa fa-trash"></i>', ['delete', 'cliente_codigo' => $data->cliente_codigo], [
