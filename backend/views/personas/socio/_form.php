...
<?php $form = ActiveForm::begin(); ?>
    <div class="row mb-3">
        ...
        <div class="col-sm-4 mb-2">
            <?= $form->field($model, 'socio_identificacion')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2 natural">
            <?= $form->field($model, 'socio_primer_nombre')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2 natural">
            <?= $form->field($model, 'socio_segundo_nombre')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2 natural">
            <?= $form->field($model, 'socio_primer_apellido')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2 natural">
            <?= $form->field($model, 'socio_segundo_apellido')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-12 mb-2 juridica">
            <?= $form->field($model, 'socio_razon_social')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2">
            <?= $form->field($model, 'socio_correo')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2">
            <?= $form->field($model, 'socio_telefono')->textInput(['maxlength' => true, 'class' => 'form-control form-control-sm']) ?>
        </div>
        <div class="col-sm-6 mb-2">
            <?php 
                if (isset($model->socio_codigo)) {
